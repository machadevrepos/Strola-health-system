...
/// Opens the report form as a bottom sheet.
///
/// [subject] names what is being reported, e.g. "post" or a user's name —
/// it appears in the sheet subtitle and the confirmation snackbar.
void showReportSheet(BuildContext context, {required String subject}) {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(AppIcons.milestone,
                        color: AppColors.error, size: AppTheme.iconM),
                ...
                ..._reasons.map((reason) {
                  ...
                  return Padding(
                    padding:
                        const EdgeInsets.only(bottom: AppTheme.spaceS),
